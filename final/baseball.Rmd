...
In this project, we are going to focus on the sabermetric statistic *wOBA*, which stands for "weighted on-base percentage." For a given sequences of a batter's plate appearances, is calculated as follows:
...
Therefore, $wOBA$ may be seen as a kind of "gold-standard" batting statistic; a player's $wOBA$ represents how many runs he tends to contribute each time he goes to bat.
